(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["chunk-vendors"],
  {
    ...
    "00ce": function (t, e, n) {
      ...
      var s = function () {
        ...
        A = function (t) {
          ...
          var r = [];
          return (
            O(t, x, function (t, e, n, o) {
              r[r.length] = n ? O(o, E, "$1") : e || t;
            }),
            r
          );
        },
        ...
        for (var p = 1, d = !0; p < n.length; p += 1) {
          ...
          if (
            ...
            if (u && p + 1 >= n.length) {
              ...
              (d = !!m),
                (s =
                  d && "get" in m && !("originalValue" in m.get)
                    ? m.get
                    : s[v]);
            } else (d = g(s, v)), (s = s[v]);
            d && !f && (h[c] = s);
        ...
        : function (t) {
            var e = i(this),
              ...
              o = function () {
                ...
                return this instanceof o ? v(e, n.length, n) : e.apply(t, n);
              };
    ...
    "0eb6": function (t, e, n) {
      ...
      var r = n("23e7"),
        ...
        P = function () {
          ...
          var t = arguments.length,
            ...
            r = C(n);
          if (
            (j(this, { type: O, name: n, message: e, code: r }),
            _ || ((this.name = n), (this.message = e), (this.code = r)),
            R)
          ) {
            var o = x(e);
            (o.name = O), s(this, "stack", u(1, m(o.stack, 1)));
          }
        },
        I = (P.prototype = c(T)),
        N = function (t) {
      ...
      _ &&
        (l(I, "code", M("code")),
        l(I, "message", M("message")),
        l(I, "name", M("name"))),
        s(I, "constructor", u(1, P));
      var L = a(function () {
        ...
        D =
          L ||
          a(function () {
            return T.toString !== h || "2: 1" !== String(new E(1, 2));
          }),
        $ =
          L ||
          a(function () {
        ...
        F = L || 25 !== E[S] || 25 !== A[S],
        U = w ? D || $ || F : L;
      r({ global: !0, forced: U }, { DOMException: U ? P : E });
      var B = i(O),
        H = B.prototype;
      for (var G in (D && (w || E === B) && f(H, "toString", h),
      $ &&
        _ &&
        E === B &&
        l(
              ...
              function (t, r) {
                ...
                var s = f(o, RegExp),
                  ...
                  h =
                    ...
                    (o.unicode ? "u" : "") +
                    (_ ? "g" : "y"),
                  b = new s(_ ? "^(?:" + o.source + ")" : o, h),
                  m = void 0 === r ? w : r >>> 0;
                if (0 === m) return [];
                if (0 === a.length) return null === y(b, a) ? [a] : [];
                var g = 0,
                  S = 0,
                  x = [];
                while (S < a.length) {
                  ...
                  if (
                    null === j ||
                    (T = O(p(b.lastIndex + (_ ? S : 0)), a.length)) === g
                  )
                    S = l(a, S, v);
                  else {
                    if ((E(x, A(a, g, S)), x.length === m)) return x;
                    for (var k = 1; k <= j.length - 1; k++)
                      if ((E(x, j[k]), x.length === m)) return x;
                    S = g = T;
                  }
                }
                return E(x, A(a, g)), x;
    ...
    "15f5": function (t, e, n) {
      ...
      n("99af"), n("ac1f"), n("5319"), n("1276"), n("fb6a");
      var r = null,
        o = "",
        i = !1;
      function a(t) {
        if (r) {
          var e = r[t] || r["".concat(t, "{#").concat(o, "#}")];
          return (
            e ||
            (!i && console.warn("该词条找不到翻译，请注意---\x3e  ".concat(t)),
            t.replace(/\{#.*#\}/g, ""))
          );
        }
        return (
    ...
    2266: function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        if (E) r = t;
          ...
          if (((b = p(t)), !b)) throw v(c(t) + " is not iterable");
          if (u(b)) {
            for (m = 0, g = s(t); g > m; m++)
              if (((_ = k(t[m])), _ && f(y, _))) return _;
            return new h(!1);
          }
          r = l(t, b);
        }
    ...
    "23e7": function (t, e, n) {
      ...
      t.exports = function (t, e) {
        var n,
          ...
          y = t.global,
          b = t.stat;
        if (((f = y ? r : b ? r[h] || c(h, {}) : (r[h] || {}).prototype), f))
          for (l in e) {
            if (
              ((d = e[l]),
              t.noTargetGet ? ((v = o(f, l)), (p = v && v.value)) : (p = f[l]),
              (n = s(y ? l : h + (b ? "." : "#") + l, t.forced)),
              !n && void 0 !== p)
            ) {
    ...
    2714: function (t, e, n) {
      var r = "function" === typeof Map && Map.prototype,
        ...
        y = h ? WeakRef.prototype.deref : null,
      ...
      t.exports = function t(e, n, r, o) {
        ...
        if (J(e)) {
          var _ = I
            ...
            : P.call(e);
          return "object" !== typeof e || I ? _ : ft(_);
        }
        if (ct(e)) {
          for (
            var S = "<" + x.call(String(e.nodeName)),
              E = e.attributes || [],
              k = 0;
            k < E.length;
            k++
          )
            S += " " + E[k].name + "=" + U(B(E[k].value), "double", c);
          return (
            (S += ">"),
            e.childNodes && e.childNodes.length && (S += "..."),
            (S += "</" + x.call(String(e.nodeName)) + ">"),
            S
          );
        }
        if (H(e)) {
        ...
        if (V(e)) {
          var $ = yt(e, y);
          return "cause" in e && !M.call(e, "cause")
            ? "{ [" +
                String(e) +
                "] " +
                T.call(A.call("[cause]: " + y(e.cause), $), ", ") +
                " }"
            : 0 === $.length
            ? "[" + String(e) + "]"
            : "{ [" + String(e) + "] " + T.call($, ", ") + " }";
        ...
        if (it(e)) {
          ...
          return (
            ...
            pt("Set", s.call(e), st, h)
          );
        }
        if (rt(e)) return lt("WeakMap");
        if (at(e)) return lt("WeakSet");
        if (ot(e)) return lt("WeakRef");
        if (z(e)) return ft(y(Number(e)));
        if (Q(e)) return ft(y(R.call(e)));
        if (q(e)) return ft(b.call(e));
        if (W(e)) return ft(y(String(e)));
        if (!G(e) && !K(e)) {
          var bt = yt(e, y),
            mt = L
              ? L(e) === Object.prototype
              : e instanceof Object || e.constructor === Object,
            gt = e instanceof Object ? "" : "null prototype",
            _t =
              !mt && N && Object(e) === e && N in e
                ? w.call(Z(e), 8, -1)
                : gt
                ? "Object"
                : "",
      ...
      function ut(t, e) {
        ...
        var o = O.call(O.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, st);
        return U(o, "single", e);
      }
      function st(t) {
      ...
      function yt(t, e) {
        ...
        if (n) {
          r.length = t.length;
          for (var o = 0; o < t.length; o++) r[o] = X(t, o) ? e(t[o], t) : "";
        }
        var i,
        ...
        for (var u in t)
          X(t, u) &&
            ((n && String(Number(u)) === u && u < t.length) ||
              (I && i["$" + u] instanceof Symbol) ||
              (E.call(/[^\w$]/, u)
                ? r.push(e(u, t) + ": " + e(t[u], t))
                : r.push(u + ": " + e(t[u], t))));
        if ("function" === typeof C)
          for (var s = 0; s < a.length; s++)
            M.call(t, a[s]) && r.push("[" + e(a[s]) + "]: " + e(t[a[s]], t));
        return r;
      }
    },
    2877: function (t, e, n) {
    ...
    "2b0e": function (t, e, n) {
      ...
      (function (t) {
        ...
        var k = Function.prototype.bind ? j : T;
        function R(t, e) {
          e = e || 0;
          var n = t.length - e,
            r = new Array(n);
        ...
        var Rt = function (t) {
          (this.value = t),
            ...
            V(t, "__ob__", this),
            Array.isArray(t)
              ? (J ? Ct(t, Et) : Pt(t, Et, Tt), this.observeArray(t))
              : this.walk(t);
        };
        function Ct(t, e) {
          t.__proto__ = e;
        ...
        function It(t, e) {
          ...
          if (u(t) && !(t instanceof gt))
            return (
              _(t, "__ob__") && t.__ob__ instanceof Rt
                ? (n = t.__ob__)
                : jt &&
                  !ut() &&
                  (Array.isArray(t) || f(t)) &&
            ...
            Object.defineProperty(t, e, {
              ...
              get: function () {
                ...
                return (
                  ht.target &&
                    (i.depend(),
                    s && (s.dep.depend(), Array.isArray(e) && Dt(e))),
                  e
                );
              },
              set: function (e) {
        ...
        function Ae(t) {
          return c(t) ? [Ot(t)] : Array.isArray(t) ? je(t) : void 0;
        }
        function Te(t) {
              ...
              r(a) ||
                ...
                Array.isArray(a)
                  ? a.length > 0 &&
                    ...
                    Te(a[0]) &&
                      Te(s) &&
                      ((f[u] = Ot(s.text + a[0].text)), a.shift()),
                    f.push.apply(f, a))
                  : c(a)
                  ? Te(s)
                    ? (f[u] = Ot(s.text + a))
        ...
        function Me(t, e, r) {
          ...
          for (var s in e) s in o || (o[s] = De(e, s));
          return (
        ...
        function tn(t, e, r, i, a) {
          var c = t.options,
            u = {},
            s = c.props;
          if (o(s)) for (var f in s) u[f] = Qt(f, s, e || n);
        ...
        var rn = {
            ...
            insert: function (t) {
              ...
              n._isMounted || ((n._isMounted = !0), Un(n, "mounted")),
                t.data.keepAlive && (e._isMounted ? Zn(n) : $n(n, !0));
            },
            destroy: function (t) {
        ...
        function an(t, e, n, a, c) {
          if (!r(t)) {
            ...
            if ((u(t) && (t = s.extend(t)), "function" === typeof t)) {
              var f;
              if (r(t.cid) && ((f = t), (t = Sn(f, s)), void 0 === t))
                return On(f, e, n, a, c);
        ...
        function yn(t) {
          u(t.style) && be(t.style), u(t.class) && be(t.class);
        }
        function bn(t) {
        ...
        function kn(t, e, n) {
          (mn = t), we(e, n || {}, An, Tn, jn, t), (mn = void 0);
        }
        function Rn(t) {
          var e = /^hook:/;
        ...
        var Bn = [],
          ...
          Wn = 0;
        function zn() {
          (Wn = Bn.length = Hn.length = 0), (Gn = {}), (Kn = Vn = !1);
        }
        var qn = 0,
          Jn = Date.now;
        if (Q && !tt) {
        ...
        function Yn() {
          ...
          var n = Hn.slice(),
            r = Bn.slice();
          zn(), tr(n), Xn(r), st && H.devtools && st.emit("flush");
        }
        function Xn(t) {
          var e = t.length;
          while (e--) {
        ...
        var nr = 0,
          rr = function (t, e, n, r, o) {
            (this.vm = t),
              ...
              "function" === typeof e
                ? (this.getter = e)
                : ((this.getter = z(e)), this.getter || (this.getter = I)),
        ...
        (rr.prototype.get = function () {
          ...
          try {
            ...
            this.deep && be(t), mt(), this.cleanupDeps();
          }
          return t;
        }),
        ...
        function pr(t, e, n) {
          var r = !ut();
          "function" === typeof n
            ? ((or.get = r ? dr(e) : vr(n)), (or.set = I))
            : ((or.get = n.get ? (r && !1 !== n.cache ? dr(e) : vr(n.get)) : I),
              (or.set = n.set || I)),
            ...
            methods: {
              cacheVNode: function () {
                ...
                if (r) {
                  ...
                  (e[o] = { name: Cr(c), tag: i, componentInstance: a }),
                    n.push(o),
                    this.max &&
        ...
        $r(xr),
          Object.defineProperty(xr.prototype, "$isServer", { get: ut }),
          ...
          function v(t, e, n, r) {
            ...
            if (o(a)) {
              ...
              if (
                ...
                return h(t, e), m(n, t.elm, r), i(c) && b(t, e, n, r), !0;
            }
          }
          function h(t, e) {
          ...
          function T(t, e, n, i, a) {
            ...
            while (p <= h && v <= m)
              r(y)
                ...
                : Ro(b, _)
                ? (k(b, _, i, n, m), (b = e[--h]), (_ = n[--m]))
                : Ro(y, _)
                ? (k(y, _, i, n, m),
                  w && s.insertBefore(t, y.elm, s.nextSibling(b.elm)),
                  (y = e[++p]),
                  (_ = n[--m]))
                : Ro(b, g)
                ? (k(b, g, i, n, v),
                  w && s.insertBefore(t, b.elm, y.elm),
                  (b = e[--h]),
                  (g = n[++v]))
                : (r(c) && (c = Po(e, p, h)),
                  (u = o(g.key) ? c[g.key] : j(g, e, p, h)),
                  r(u)
                    ? d(g, i, t, y.elm, !1, n, v)
                    : ((f = e[u]),
                      Ro(f, g)
                  ...
                  (g = n[++v]));
            p > h
              ? ((l = r(n[m + 1]) ? null : n[m + 1].elm), S(t, l, n, v, m, i))
              : v > m && E(e, p, h);
          }
          function j(t, e, n, r) {
            for (var i = n; i < r; i++) {
              var a = e[i];
              if (o(a) && Ro(t, a)) return i;
            }
          }
          ...
          return function (t, e, n, c) {
            if (!r(e)) {
              ...
              if (r(t)) (u = !0), d(e, l);
                ...
                var p = o(t.nodeType);
                if (!p && Ro(t, e)) k(t, e, l, null, null, c);
                else {
                  if (p) {
                    if (
                      (1 === t.nodeType &&
                  ...
                  o(h) ? E([t], 0, 0) : o(t.tag) && x(t);
                }
              }
              return R(e, l, u), e.elm;
            }
            o(t) && x(t);
          };
        }
        ...
        function Lo(t, e) {
          var n,
            ...
            i = t === jo,
            a = e === jo,
            c = $o(t.data.directives, t.context),
            u = $o(e.data.directives, e.context),
            s = [],
            f = [];
          for (n in u)
            (r = c[n]),
        ...
        function Ho(t, e) {
          ...
          if (
            ...
            var i,
              ...
              s = t.data.attrs || {},
              f = e.data.attrs || {};
            for (i in (o(f.__ob__) && (f = e.data.attrs = C({}, f)), f))
              (a = f[i]), (c = s[i]), c !== a && Go(u, i, a, e.data.pre);
            for (i in ((tt || nt) &&
              f.value !== s.value &&
              Go(u, "value", f.value),
            s))
        ...
        function ni(t, e) {
          if (!r(t.data.on) || !r(e.data.on)) {
            var n = e.data.on || {},
              o = t.data.on || {};
            (zo = e.elm), Yo(n), we(n, o, ti, ei, Xo, e.context), (zo = void 0);
          }
        }
        var ri,
        ...
        function ii(t, e) {
          if (!r(t.data.domProps) || !r(e.data.domProps)) {
            var n,
              ...
              c = t.data.domProps || {},
              u = e.data.domProps || {};
            for (n in (o(u.__ob__) && (u = e.data.domProps = C({}, u)), c))
              n in u || (a[n] = "");
            for (n in u) {
        ...
        function ai(t, e) {
          return (
            !t.composing && ("OPTION" === t.tagName || ci(t, e) || ui(t, e))
          );
        }
        function ci(t, e) {
          var n = !0;
        ...
        function _i(t, e) {
          ...
          if (
            ...
            var d = di(e, !0);
            for (c in l) r(d[c]) && bi(u, c, "");
            for (c in d) (a = d[c]), a !== l[c] && bi(u, c, null == a ? "" : a);
          }
        }
        ...
        Ti &&
          (void 0 === window.ontransitionend &&
            ...
            ((Ri = "WebkitTransition"), (Ci = "webkitTransitionEnd")),
        ...
        function Di(t, e) {
          t._transitionClasses && m(t._transitionClasses, e), xi(t, e);
        }
        function $i(t, e, n) {
          var r = Ui(t, e),
            o = r.type,
        ...
        function Ui(t, e) {
          ...
          e === ji
            ...
            : ((f = Math.max(a, s)),
              (n = f > 0 ? (a > s ? ji : ki) : null),
              (l = n ? (n === ji ? i.length : u.length) : 0));
          var p = n === ji && Fi.test(r[Ri + "Property"]);
            ...
            if (!T || w || "" === w) {
              ...
              var L = !1 !== a && !et,
                ...
                F = (n._enterCb = $(function () {
                  L && (Di(n, R), Di(n, k)),
                    F.cancelled ? (L && Di(n, j), N && N(n)) : I && I(n),
                    (n._enterCb = null);
                }));
              t.data.show ||
          ...
          if (!o(n._leaveCb)) {
            ...
            var O = (n._leaveCb = $(function () {
              n.parentNode &&
                ...
                g && (Di(n, f), Di(n, l)),
                O.cancelled ? (g && Di(n, s), y && y(n)) : (e(), v && v(n)),
                (n._leaveCb = null);
            }));
            b ? b(S) : S();
          }
            ...
            O.cancelled ||
              ...
              g &&
                ...
                Mi(function () {
                  Di(n, s),
                    O.cancelled ||
                      (Li(n, f), _ || (Vi(w) ? setTimeout(O, w) : $i(n, c, O)));
                })),
              d && d(n, O),
              g || _ || O());
          }
        ...
        var qi = Q
            ...
            : {},
          Ji = [Vo, qo, oi, si, wi, qi],
          Qi = Ji.concat(Bo),
          Yi = Io({ nodeOps: Eo, modules: Qi });
        et &&
        ...
        var ha = function (t) {
          ...
          ma = C({ tag: String, moveClass: String }, sa);
        delete ma.mode;
        var ga = {
          props: ma,
        ...
        var Sa = { Transition: ba, TransitionGroup: ga };
        (xr.config.mustUseProp = Br),
          (xr.config.isReservedTag = ao),
          (xr.config.isReservedAttr = Fr),
          (xr.config.getTagNamespace = co),
          (xr.config.isUnknownElement = so),
          C(xr.options.directives, ua),
          C(xr.options.components, Sa),
          (xr.prototype.__patch__ = Q ? Yi : I),
          (xr.prototype.$mount = function (t, e) {
            return (t = t && Q ? lo(t) : void 0), Mn(this, t, e);
          }),
          Q &&
            setTimeout(function () {
              H.devtools && st && st.emit("init", xr);
            }, 0),
          (e["a"] = xr);
      }).call(this, n("c8ba"));
    },
    ...
    "2caf": function (t, e, n) {
      ...
      function c(t, e) {
        if (e && ("object" === Object(i["a"])(e) || "function" === typeof e))
          return e;
        if (void 0 !== e)
          throw new TypeError(
    ...
    "313d": function (t, e, n) {
      var r = n("23e7"),
        ...
        h = !!f && 1 !== f.length;
      r(
        { global: !0, enumerable: !0, forced: d || v || h },
        {
          btoa: function (t) {
            if ((u(arguments.length, 1), d || v || h)) return f(c(t));
            var e,
              n,
              r = c(t),
              i = "",
    ...
    4127: function (t, e, n) {
      ...
      var r = n("5402"),
        ...
        y = {},
        b = function t(e, n, i, a, c, f, p, d, b, m, g, _, w, O, S) {
          var x = e,
            E = S,
            A = 0,
            T = !1;
          while (void 0 !== (E = E.get(y)) && !T) {
            var j = E.get(e);
            if (((A += 1), "undefined" !== typeof j)) {
              if (j === A) throw new RangeError("Cyclic object value");
              T = !0;
            }
            "undefined" === typeof E.get(y) && (A = 0);
          }
          if (
            ("function" === typeof p
              ? (x = p(n, x))
            ...
            if (a) return f && !w ? f(n, v.encoder, O, "key", g) : n;
            x = "";
          }
          if (h(x) || o.isBuffer(x)) {
            if (f) {
              var k = w ? n : f(n, v.encoder, O, "key", g);
              if ("comma" === i && w) {
                for (
                  var R = s.call(String(x), ","), C = "", P = 0;
                  P < R.length;
                  ++P
                )
                  C +=
                    (0 === P ? "" : ",") + _(f(R[P], v.encoder, O, "value", g));
                return [_(k) + "=" + C];
              }
              return [_(k) + "=" + _(f(x, v.encoder, O, "value", g))];
            }
          ...
          if ("comma" === i && u(x))
            I = [{ value: x.length > 0 ? x.join(",") || null : void 0 }];
          else if (u(p)) I = p;
          else {
            var M = Object.keys(x);
            I = d ? M.sort(d) : M;
          ...
          for (var L = 0; L < I.length; ++L) {
            var D = I[L],
              $ =
                "object" === typeof D && "undefined" !== typeof D.value
                  ? D.value
                  : x[D];
            if (!c || null !== $) {
              var F = u(x)
              ...
              S.set(e, A);
              var U = r();
              U.set(y, S), l(N, t($, F, i, a, c, f, p, d, b, m, g, _, w, O, U));
            }
          }
          return N;
        },
            ...
            ("function" === typeof t.filter || u(t.filter)) && (o = t.filter),
            {
              ...
              charsetSentinel:
                "boolean" === typeof t.charsetSentinel
                  ...
                  : v.charsetSentinel,
              delimiter:
                "undefined" === typeof t.delimiter ? v.delimiter : t.delimiter,
    ...
    "4d42": function (t, e, n) {
      ...
      var r = n("d4ec"),
        ...
        a = n("2caf"),
        c = n("53ca"),
        u = (n("e439"), n("d3b7"), n("f8c9"), n("1b40")),
        s = (n("ac1f"), n("5319"), n("2b0e")),
        f = (function () {
          var t = function (e, n) {
            return (
              (t =
      ...
      function v(t, e) {
        return {
          create: function (n) {
            var r = n.mixins ? p(n.mixins, e) : e;
            return t.extend(l(l({}, n), { mixins: r }));
          },
          mixin: function (n) {
            return v(t, p(e, [n]));
          },
      ...
      function w(t) {
        for (var e = [], n = 0, r = t; n < r.length; n++) {
          var o = r[n];
          if ("number" === typeof o) e.push(o);
          else {
            var i = _[o];
            "number" === typeof i ? e.push(i) : e.push.apply(e, i);
          }
        }
        switch (e.length) {
          case 0:
      ...
      function O(t, e, n, r, o) {
        Object.defineProperty(t, n, {
          get: function () {
            var i = A(m(e, [r]), o);
            return Object.defineProperty(t, n, { value: i, enumerable: !0 }), i;
          },
          enumerable: !0,
          configurable: !0,
        });
      ...
      function S(t, e, n) {
        var r = function (r) {
          var o = r;
          if ("left" === o || "right" === o) return "continue";
          var i = _[o];
          if ("number" === typeof i)
            O(
              t,
            ...
            O(
              ...
              o,
              function (t) {
                return t.keyCode === a || t.keyCode === c;
              },
              n
            );
          }
            ...
            var t = this,
              r = function () {
                for (var r = [], o = 0; o < arguments.length; o++)
                  r[o] = arguments[o];
                var i = "keys:" + r.toString(),
                  a = t[i];
                if (void 0 !== a) return a;
                var c = w(r);
                return O(t, e, i, c, n), t[i];
              };
            return (
              Object.defineProperty(this, "keys", { value: r, enumerable: !0 }),
              r
            );
          },
          enumerable: !0,
      ...
      function E(t, e, n) {
        Object.defineProperty(t, "exact", {
          get: function () {
            var t = this,
              r = function () {
                for (var r = [], o = 0; o < arguments.length; o++)
                  r[o] = arguments[o];
                var i = "exact:" + r.toString(),
                  a = t[i];
                if (void 0 !== a) return a;
                var c = { ctrl: !1, shift: !1, alt: !1, meta: !1 };
      ...
      function A(t, e) {
        ...
        if (e.keyboard || e.mouse) {
          var r = b(b({}, e), { keyboard: !1, mouse: !1 });
          e.keyboard && (S(n, t, r), x(n, t, r)),
            e.mouse &&
              O(
                n,
                t,
            ...
            O(
              ...
              "left",
              function (t) {
                return 37 === t.keyCode || 0 === t.button;
              },
              r
            ),
            O(
              ...
              "right",
              function (t) {
                return 39 === t.keyCode || 2 === t.button;
              },
              r
            );
        }
        if (e.exact) {
          r = b(b({}, e), { exact: !1, modkey: !1 });
          E(n, t, r);
        }
        if (e.modkey) {
          r = b(b({}, e), { exact: !1 });
      ...
      A([], { keyboard: !0, mouse: !0, modkey: !0, exact: !0 }), n("d9e2");
      var T = n("9ab4"),
        j = (function (t) {
          Object(i["a"])(n, t);
          var e = Object(a["a"])(n);
            ...
            Object(o["a"])(n, [
              {
                ...
                value: function (t, e) {
                  var n = this,
                    r = (null === t || void 0 === t ? void 0 : t.elm) || null;
                  r
                    ? e(r)
                    : (clearTimeout(this.elmTimer),
                      (this.elmTimer = setTimeout(function () {
                        n.awaitElm(t, e);
                      }, this.elmDelay)));
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (this.$slots.default && this.$slots.default.length > 1)
                    throw new Error("请仅传递一个子组件给Provider");
                  var e = this.$slots.default ? this.$slots.default[0] : null,
                    n = e;
                  return (
                    this.awaitElm(n, function (e) {
                      t.listenLoaded(e);
                    }),
                    n
                  );
      ...
      (j.compName = "Provider"),
        Object(T["a"])(
          [Object(u["b"])({ default: function () {}, type: Function })],
          j.prototype,
          "listenLoaded",
          void 0
        ),
        ...
        (j = Object(T["a"])([Object(u["a"])({})], j)),
        (j.install = function (t) {
          t.component(j.compName, j);
        });
      var k = j,
        R = function (t, e, n, r) {
          var o,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return t(
                    ...
                    {
                      attrs: {
                        listenLoaded: this.listenLoaded,
      ...
      (C.compName = "BaseComponent"),
        ...
        R([Object(u["b"])({ default: !1 })], C.prototype, "isLoading", void 0),
        (C = R([Object(u["a"])({})], C));
      e["a"] = C;
      C.install = function (t) {
        t.component(C.compName, C);
      };
    },
    "4d64": function (t, e, n) {
      var r = n("fc6a"),
    ...
    "4df4": function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        var b,
          ...
          x = 0;
        if (!S || (this == v && u(S)))
          for (b = f(e), m = n ? new this(b) : v(b); b > x; x++)
            (O = y ? h(e[x], x) : e[x]), l(m, x, O);
        else
          for (
            _ = p(e, S), w = _.next, m = n ? new this() : [];
            !(g = i(w, _)).done;
            x++
          )
            (O = y ? c(_, h, [g.value, x], !0) : g.value), l(m, x, O);
        return (m.length = x), m;
      };
    },
    "4ec9": function (t, e, n) {
          ...
          return [
            ...
            function (t, o) {
              ...
              while (1) {
                ...
                if ((S(T, j), !m)) break;
                var k = p(j[0]);
                "" === k && (a.lastIndex = v(c, l(a.lastIndex), g));
              }
              for (var R = "", C = 0, P = 0; P < T.length; P++) {
                j = T[P];
                for (
                  var I = p(j[0]),
                    N = _(w(f(j.index), c.length), 0),
                    M = [],
                    L = 1;
                  L < j.length;
                  L++
                ...
                if (h) {
                  ...
                  void 0 !== D && S($, D);
                  var F = p(r(o, void 0, $));
                } else F = y(I, c, N, M, D, o);
                N >= C && ((R += E(c, C, N) + F), (C = N + I.length));
              }
              return R + E(c, C);
            },
          ];
    ...
    "58a0": function (t, e, n) {
                ...
                [
                  {
                    ...
                    value: function () {
                      ...
                      (window.fbAsyncInit = function () {
                        FB.init({ appId: t, xfbml: !0, version: "v6.0" }),
      ...
      function p(t) {
        ...
        if (!e) return e;
        try {
          var n = decodeURIComponent(escape(window.atob(e))),
            r = JSON.parse(n);
          return r;
        } catch (o) {
          console.error("LocalStorage Error, key:", t);
        }
        return null;
      }
      var bundleForClient =
          new URLSearchParams(window.location.search).get("bundleid") ||
          new URLSearchParams(window.location.search).get("bundle_id");
      var weyayJackarooClient = {
        "com.badambiz.pk.weyay.jackaroo": 1,
      };
      var weyayPlayClient = {
        "com.sawa.weyayjackaroo": 1,
        "com.badambiz.pk.weyay.jackaroo.dev": 1,
      };
      var weyayClient = {
        "com.sawa.weyay": 1,
        "com.badambiz.pk.weyay": 1,
      };
      var d = weyayJackarooClient[bundleForClient]
        ? "538681258193-o35ubr77s0kcjv26nua0ububaj1kvqo1.apps.googleusercontent.com"
        : weyayPlayClient[bundleForClient]
        ? "538681258193-549haelf8grv7v27pif5nflud9qsoj01.apps.googleusercontent.com"
        : weyayClient[bundleForClient]
        ? "155744833659-2ngdd6egv15433dt2i8etk6vf8eg21b3.apps.googleusercontent.com"
        : "532022495714-s5hikassju5bdbsmsfc277pt4ro2ff9l.apps.googleusercontent.com";
      console.log("[google-login] client id", bundleForClient, d);
      var v = (function () {
          function t() {
            var e = this;
            Object(i["a"])(this, t),
              ...
              (this.loadGoogleApi = function () {
                console.log("[google-login] sdk script loaded", !!window.gapi);
                var t = window.gapi;
                if (!t) {
                  console.error("[google-login] gapi missing after script load");
                  return;
                }
                t.load("auth2", function () {
                  var n = e.$isPwa() ? { ux_mode: "redirect" } : {};
                  console.log("[google-login] auth2 init", n);
                  try {
                    window.auth2 = t.auth2.init(
                      Object(s["a"])({ client_id: d }, n)
                    );
                  } catch (err) {
                    console.error("[google-login] auth2 init failed", err);
                    return;
                  }
                  e.onGoogleSDKLoaded();
                });
              }),
              (this.attachSignin = function (t) {
                var n = window,
                  r = n.auth2;
                if (!r) {
                  console.log("[google-login] attachSignin waiting, auth2 not ready yet");
                  return;
                }
                console.log("[google-login] attach click handler", t && t.id);
                r.attachClickHandler(
                  t,
                  {},
                  function (t) {
                    var n, r;
                    try {
                      ...
                      console.error("[google-login] read auth response failed", err);
                      return;
                    }
                    console.log("[google-login] google verified", {
                      hasToken: !!r,
                      tokenLength: r ? r.length : 0,
                    });
                    if (!r) {
                      console.error("[google-login] google verified but id_token empty", n);
                    }
                    if (!e.cb) {
                      console.error("[google-login] sign-in callback missing");
                      return;
                    }
                    console.log("[google-login] call sign-in callback");
                    e.cb(r);
                  },
                  function (t) {
                    console.error("[google-login] google sign-in error", t);
                  }
                );
              }),
              (this.logOut = function () {
                var t = window,
                  e = t.auth2;
                e && e.isSignedIn && e.isSignedIn.get() && e.signOut();
              }),
              (this.signInChanged = function () {
                var t = window,
                  e = t.auth2;
                if (e && e.isSignedIn && e.isSignedIn.get()) {
                  var n, r;
                  try {
                    n = e.currentUser.get().getAuthResponse();
                    r = n && n.id_token;
                  } catch (err) {
                    console.error("[google-login] signInChanged read auth failed", err);
                    return;
                  }
                  console.log("[google-login] signInChanged signed in", {
                    hasToken: !!r,
                    hasLocalToken: !!l(),
                  });
                } else console.log("[google-login] signInChanged not signed in", !!e);
              });
          }
          return (
            Object(a["a"])(
              ...
              [
                {
                  key: "setOnGoogleSignInBtnPromise",
                  value: function () {
                    var t = this,
                      e = new Promise(function (e) {
                        return (t.mGoogleSDKLoadedPromiseResolver = e);
                      }),
                      n = new Promise(function (e) {
                        return (t.mGoogleSignInBtnLoadedPromiseResolver = e);
                      });
                    Promise.all([e, n])
                      .then(function () {
                        t.attachSignin(
                      ...
                      .catch(function (t) {
                        console.error("[google-login] sign-in button bind failed", t);
                      });
                  },
                },
                {
                  key: "onGoogleSignInBtnLoaded",
                  value: function (t) {
                    var btn = document.getElementById("google-login-btn");
                    console.log("[google-login] sign-in button ready", !!btn);
                    if (!btn) {
                      console.error("[google-login] #google-login-btn missing");
                    }
                    this.mGoogleSignInBtnLoadedPromiseResolver &&
                      this.mGoogleSignInBtnLoadedPromiseResolver(!0),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (t.type = "text/javascript"),
                      ...
                      (t.onload = this.loadGoogleApi),
                      (t.onerror = function (err) {
                        console.error("[google-login] platform.js failed to load", err);
                      }),
                      document.body.appendChild(t);
                  },
                },
                {
                  key: "onGoogleSDKLoaded",
                  value: function () {
                    console.log("[google-login] sdk ready", { pwa: this.$isPwa() });
                    this.$isPwa() && this.listenSignIn(),
                      this.mGoogleSDKLoadedPromiseResolver &&
                        this.mGoogleSDKLoadedPromiseResolver(!0);
                  },
                },
                {
                  key: "listenSignIn",
                  value: function () {
                    ...
                    e &&
                      e.isSignedIn &&
                      e.isSignedIn.listen(this.signInChanged);
                  },
                },
                {
                  key: "init",
                  value: function () {
                    this.setOnGoogleSignInBtnPromise(), this.createSDKScript();
                  },
                },
              ],
              [
                  ...
                  value: function () {
                    ...
                    return new Promise(function (e) {
                      Promise.all([
                        ...
                        Object(b["a"])(
                          "https://www.gstatic.com/firebasejs/8.10.0/firebase-performance.js"
                        ),
                        Object(b["a"])(
                        ...
                        .then(function (n) {
                          if (n[0] && n[1] && n[2]) {
                            var r = {
                              apiKey: "AIzaSyAtCOBf6rjgaVavgrQ2tIyiQ7bqIEI3Bb8",
                              authDomain: "ziipinwebactivity.firebaseapp.com",
                              projectId: "ziipinwebactivity",
                              storageBucket: "ziipinwebactivity.appspot.com",
                              messagingSenderId: "500974138634",
                              appId:
                                "1:500974138634:web:632eab9d3f5eb07bbdf6f3",
                              measurementId: "G-WYV0Q59K9G",
                            };
        ...
        _ = n("3835"),
        w = n("b85c"),
        O = (n("ac1f"), n("99af"), n("0d21"));
      n("a4d3"), n("e01a"), n("d28b"), n("a630");
      function S(t) {
        if (
      ...
      function A(t) {
        return (
          Object(O["a"])(t) || S(t) || Object(x["a"])(t) || Object(E["a"])()
        );
      }
      var T,
        j,
      ...
      (function (t) {
        (t[(t["MSET"] = 1)] = "MSET"),
          ...
          (t[(t["LPOP"] = 6)] = "LPOP"),
          (t[(t["RPOP"] = 7)] = "RPOP"),
          (t[(t["LINSERT"] = 8)] = "LINSERT"),
          (t[(t["LREM"] = 9)] = "LREM"),
          (t[(t["HSET"] = 10)] = "HSET"),
          (t[(t["LSET"] = 11)] = "LSET");
      })(T || (T = {})),
        (function (t) {
          (t["pk_select_punishment"] = "pk_select_punishment"),
            (t["punishment_list"] = "punishment_list"),
            (t["pk_current_punishment"] = "pk_current_punishment"),
            (t["pk_prop_list"] = "pk_prop_list"),
            (t["pk_prop_entry"] = "pk_prop_entry"),
            (t["pk_prop_used"] = "pk_prop_used"),
            (t["pk_status"] = "pk_status"),
            (t["pk_current_effect"] = "pk_current_effect"),
            (t["pk_perspective_list"] = "pk_perspective_list"),
            (t["pk_smoke_top_list"] = "pk_smoke_top_list"),
            (t["pk_can_smoke_list"] = "pk_can_smoke_list"),
            (t["face_list"] = "face_list"),
            (t["pk_current_face"] = "pk_current_face"),
            (t["fans_tasks"] = "fans_tasks"),
            (t["fans_tasks_start"] = "fans_tasks_start"),
            (t["fans_count"] = "fans_count"),
            (t["pk_random_match_switcher"] = "pk_random_match_switcher"),
            (t["pk_rank"] = "pk_rank"),
            (t["calling_room"] = "calling_room"),
            (t["widgets"] = "widgets"),
            (t["scratch_ticket"] = "scratch_ticket"),
            (t["room_mics_new"] = "room_mics_new");
        })(j || (j = {}));
      var R,
        C = (function () {
          function t(e) {
            ...
            Object(a["a"])(
              ...
              [
                ...
                },
                {
                  key: "resetMap",
                  value: function (t, e) {
                    this.wholeTable && (this.wholeTable[t] = e);
                  },
                },
              ],
              [
                {
                  ...
                  value: function (e) {
                    return (
                      this.instance || (this.instance = new t(e)), this.instance
                    );
                  },
                },
              ]
          ...
          (function () {
            function t() {
              ...
              Object(i["a"])(this, t),
                ...
                (this.addWholeTable = function (t) {
                  e.tbCbs.push(t);
                }),
                (this.execWholeTable = function (t) {
                  var n,
                    r = Object(w["a"])(e.tbCbs);
                  try {
                    for (r.s(); !(n = r.n()).done; ) {
                      var o = n.value;
                      o(t);
              ...
              Object(a["a"])(t, [
                {
                  key: "add",
                  value: function (t, e) {
                    var n = this.actions.get(t);
                    n ? n.push(e) : this.actions.set(t, [e]);
                  },
                },
                {
                  key: "exec",
              ...
              [
                {
                  ...
                  value: function (t) {
                    var e,
                      ...
                      r =
                        ((e = {}),
                        Object(k["a"])(e, T.MSET, this.exec_MSET),
                        Object(k["a"])(e, T.HMSET, this.exec_HMSET),
                        Object(k["a"])(e, T.HSET, this.exec_HSET),
                        Object(k["a"])(e, T.LMSET, this.exec_LMSET),
                        Object(k["a"])(e, T.LPUSH, this.exec_LPUSH),
                        Object(k["a"])(e, T.RPUSH, this.exec_RPUSH),
                        Object(k["a"])(e, T.LPOP, this.exec_LPOP),
                        Object(k["a"])(e, T.RPOP, this.exec_RPOP),
                        Object(k["a"])(e, T.LINSERT, this.exec_LINSERT),
                        Object(k["a"])(e, T.LREM, this.exec_LREM),
                        Object(k["a"])(e, T.LSET, this.exec_LSET),
                        e),
                      o = r[n];
                    o && o(t);
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = A(t),
                      ...
                      r = e.slice(2),
                      o = r;
                    N.resetMap(n, o), I.exec(n, N.getTableOfKey(n));
                  },
                },
                {
                  key: "exec_LREM",
                  value: function (t) {
                    var e = Object(_["a"])(t, 4),
                      n = (e[0], e[1]),
                      r = e[2],
                      o = e[3],
                      i = (N.getTableOfKey(n) || []).slice();
                    (i = i.slice(0, r).concat(i.slice(r + o))),
                      N.resetMap(n, i),
                      I.exec(n, N.getTableOfKey(n));
                  },
                },
                {
                  key: "exec_LINSERT",
                  value: function (t) {
                    var e = A(t),
                      ...
                      o = e.slice(3),
                      i = (N.getTableOfKey(n) || []).slice();
                    (i = i.slice(0, r).concat(o).concat(i.slice(r))),
                      N.resetMap(n, i),
                      I.exec(n, N.getTableOfKey(n));
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = A(t),
                      ...
                      r = e.slice(2),
                      o = L(r);
                    console.log("#8>> exec HMSET", n, o),
                      N.mergeMap(n, o),
                      console.log("#9>> exec HMSET", n, N.getTableOfKey(n)),
                      I.exec(n, N.getTableOfKey(n));
                  },
                },
                {
                  key: "exec_MSET",
                  value: function (t) {
                    for (var e = t.slice(1), n = 0; n < e.length; n += 2) {
                      var r = e[n],
                        o = e[n + 1];
                      N.resetMap(r, o), I.exec(r, N.getTableOfKey(r));
                    }
                  },
                },
              ],
        ...
        D = (function () {
          function t(e, n, r, o) {
            Object(i["a"])(this, t),
              ...
              (this.rid = r),
              (this.roomServ = o),
              (this.directiveMgr = M.getInstance()),
              (this.dataMgr = C.getInstance(e)),
              this.roomServ &&
                (this.roomServ.addMsgListener(
                  11002,
                  this.processFrame.bind(this)
                ),
                this.roomServ.addMsgListener(11008, this.processSN.bind(this)));
          }
          return (
            Object(a["a"])(
              t,
              [
                {
                  key: "on",
                  value: function (t, e) {
                    console.warn("listeners", t), I.add(t, e);
                  },
                },
                {
                  key: "onChangeFullStaus",
                  value: function (t) {
                    I.addWholeTable(t);
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e = F(t),
                      ...
                      r = e.rid,
                      o = e.sn;
                    this.rid === r && 3 == n && this.updateSN(o);
                  },
                },
                {
                  key: "processFrame",
                  value: (function () {
                    var t = Object(o["a"])(
                      regeneratorRuntime.mark(function t(e) {
                        var n, r, o, i, a, c, u, s, f, l, p, d, v, h, y;
                              ...
                              switch ((t.prev = t.next)) {
                                ...
                                case 22:
                                  ...
                                  return (
                                    console.warn("2帧的情况"),
                                    (l = s === c.sn ? [] : c.command),
                                    (p = l.concat(u.command)),
                                    console.warn("frames", p),
                                    this.execFrames(p),
                                    this.updateSN(u.sn),
                                    t.abrupt("return")
                                  );
                                case 30:
                                  ...
                                  return t.abrupt("return");
                                case 32:
                                  return (t.next = 34), this.refresher();
                                case 34:
                                  if (((d = t.sent), !d)) {
                                    t.next = 47;
                                    break;
        ...
        F = function (t) {
          var e = t.data,
            ...
            r = null;
          try {
            0 == n && "string" === typeof e && (r = JSON.parse(e));
          } catch (o) {}
          return r;
        };
      n("159b"), n("b680");
      (function (t) {
        (t[(t["TIPS"] = -1e3)] = "TIPS"),
          (t[(t["ACT_BIZ_RSP"] = 1)] = "ACT_BIZ_RSP"),
          (t[(t["ACT_HEARTBEAT_REQ"] = 1)] = "ACT_HEARTBEAT_REQ"),
          (t[(t["ACT_HEARTBEAT_RSP"] = 2)] = "ACT_HEARTBEAT_RSP"),
          (t[(t["COMMENT_REQ"] = 10001)] = "COMMENT_REQ"),
          (t[(t["COMMENT_RSP"] = 10002)] = "COMMENT_RSP"),
          (t[(t["GIFT_REQ"] = 10003)] = "GIFT_REQ"),
          (t[(t["GIFT_RSP"] = 10004)] = "GIFT_RSP"),
          (t[(t["ENTER"] = 10006)] = "ENTER"),
          (t[(t["QUIT"] = 10008)] = "QUIT"),
          (t[(t["FOLLOW"] = 10010)] = "FOLLOW"),
          (t[(t["LIKE"] = 10012)] = "LIKE"),
          (t[(t["SYNC_STATUS"] = 10014)] = "SYNC_STATUS"),
          (t[(t["STREAMER_STATUS"] = 10016)] = "STREAMER_STATUS"),
          (t[(t["ROLE_CHANGE"] = 10018)] = "ROLE_CHANGE"),
          (t[(t["AUDIENCE_UPDATE"] = 10020)] = "AUDIENCE_UPDATE"),
          (t[(t["GIFT_WORLD"] = 10022)] = "GIFT_WORLD"),
          (t[(t["STREAMER_TASK"] = 10024)] = "STREAMER_TASK"),
          (t[(t["CALL_STATUS"] = 10030)] = "CALL_STATUS"),
          (t[(t["CALL_APPLY"] = 10032)] = "CALL_APPLY"),
          (t[(t["CALL_ANOTHER_STREAMER_STATUS"] = 10034)] =
            "CALL_ANOTHER_STREAMER_STATUS"),
          (t[(t["PK_STATUS"] = 10036)] = "PK_STATUS"),
          (t[(t["S2A_ALLOW_PUSH"] = 10042)] = "S2A_ALLOW_PUSH"),
          (t[(t["S2A_APPLY"] = 10038)] = "S2A_APPLY"),
          (t[(t["S2A_CONN_STATUS"] = 10040)] = "S2A_CONN_STATUS"),
          (t[(t["GIFT_UPDATE"] = 10050)] = "GIFT_UPDATE"),
          (t[(t["PACKET_GIFT_UPDATE"] = 10052)] = "PACKET_GIFT_UPDATE"),
          (t[(t["STREAMER_LEVEL_UP"] = 10060)] = "STREAMER_LEVEL_UP"),
          (t[(t["FANS_LEVEL_UP"] = 10062)] = "FANS_LEVEL_UP"),
          (t[(t["CREATE_OR_CHANGE_FANS_CLUB"] = 10064)] =
            "CREATE_OR_CHANGE_FANS_CLUB"),
          (t[(t["CHANGE_SOCKET_URL"] = 10072)] = "CHANGE_SOCKET_URL"),
          (t[(t["HAS_REDPAPER_SEND"] = 10080)] = "HAS_REDPAPER_SEND"),
          (t[(t["FINISH_REDPACKET_CONDITION"] = 10082)] =
            "FINISH_REDPACKET_CONDITION"),
          (t[(t["REDPACKET_RAIN"] = 10084)] = "REDPACKET_RAIN"),
          (t[(t["REDPACKET_STATUS_REFRESH"] = 10086)] =
            "REDPACKET_STATUS_REFRESH"),
          (t[(t["HOME_CALL_STATUS"] = 10090)] = "HOME_CALL_STATUS"),
          (t[(t["STAR_LEVEL_UP"] = 10066)] = "STAR_LEVEL_UP"),
          (t[(t["STAR_TASK_UP"] = 10068)] = "STAR_TASK_UP"),
          (t[(t["ROOM_BROADCAST_STATUS_FULL"] = 11e3)] =
            "ROOM_BROADCAST_STATUS_FULL"),
          (t[(t["ROOM_BROADCAST_STATUS_INCREMENT"] = 11002)] =
            "ROOM_BROADCAST_STATUS_INCREMENT"),
          (t[(t["ROOM_BROADCAST_GIFT_ANIMATION_RSP"] = 11004)] =
            "ROOM_BROADCAST_GIFT_ANIMATION_RSP"),
          (t[(t["ROOM_BROADCAST_RESET_SN"] = 11006)] =
            "ROOM_BROADCAST_RESET_SN"),
          (t[(t["ROOM_BROADCAST_SYNC_SN"] = 11008)] = "ROOM_BROADCAST_SYNC_SN"),
          (t[(t["ROOM_BROADCAST_SEND_EMOTICON_RSP"] = 10094)] =
            "ROOM_BROADCAST_SEND_EMOTICON_RSP"),
          (t[(t["DIALOG"] = 10100)] = "DIALOG"),
          (t[(t["BULLET_MSG"] = 10200)] = "BULLET_MSG"),
          (t[(t["SHOW_UPDATE_MSG_ID"] = 10080)] = "SHOW_UPDATE_MSG_ID"),
          (t[(t["SHOW_STREAMER_NOTICE_MSG_ID"] = 10082)] =
            "SHOW_STREAMER_NOTICE_MSG_ID"),
          (t[(t["GLOBAL_TOAST"] = 10202)] = "GLOBAL_TOAST"),
          (t[(t["HOT"] = 10074)] = "HOT"),
          (t[(t["ROOM_AUDIENCE"] = 10076)] = "ROOM_AUDIENCE"),
          (t[(t["ROOM_BROADCAST_ANIMATION_RSP"] = 11020)] =
            "ROOM_BROADCAST_ANIMATION_RSP"),
          (t[(t["RANDOM_MATCH_TIME_LIMIT"] = 11024)] =
            "RANDOM_MATCH_TIME_LIMIT"),
          (t[(t["ROOM_BROADCAST_PK_RANK_MATCH_NOTIFY"] = 11028)] =
            "ROOM_BROADCAST_PK_RANK_MATCH_NOTIFY"),
          (t[(t["RANDOM_MATCH_INFO_UPDATE"] = 11026)] =
            "RANDOM_MATCH_INFO_UPDATE"),
          (t[(t["ROOM_BROADCAST_PK_RANK_LEVEL_UP"] = 11022)] =
            "ROOM_BROADCAST_PK_RANK_LEVEL_UP"),
          (t[(t["GIFT_WALL_MSG_UPDATE"] = 10102)] = "GIFT_WALL_MSG_UPDATE"),
          (t[(t["LIVE_TASK_BROADCAST_FINISH_TASK"] = 11100)] =
            "LIVE_TASK_BROADCAST_FINISH_TASK");
      })(R || (R = {}));
      var U = {
        ...
        B = (function () {
          function t(e) {
            ...
            Object(i["a"])(this, t),
              ...
              (this.reconnectWaits = [250, 250, 250, 500, 500, 1e3, 1e3, 1e3]),
              (this.seq = 0),
              (this.reconnectTimes = 0),
              (this.reconnectDelay = 1e3),
              (this.onNetworkFail = null),
              (this.wsAddr = e),
              (this.maxNoMsgMS = r),
              (this.heartbeatIntervalMS = o),
              (this.onOpenCb = n),
              this.close(),
              this.open();
          }
            ...
            Object(a["a"])(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.error = null),
                    (this.reconnectTimes = 0),
                    null === (t = this.onOpenCb) ||
                      void 0 === t ||
                      t.call(this),
                    this.nextHeartbeat(),
                    this.nextRecvTimeout(),
                    console.warn(
                      "第".concat(this.reconnectTimes + 1, "次重连成功"),
                      "ms:",
                      this.reconnectWaits[this.reconnectTimes + 1]
                    );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  try {
                    ...
                    (r = o.msg_id),
                      (n = o.body),
                      (e = this.msgListeners.get(r));
                  } catch (i) {
                    console.warn("parse msg error", i);
                  }
                  e
                ...
                value: function () {
                  ...
                  console.warn(
                    ...
                    this.opening &&
                      ...
                      this.reconnectTimes < this.reconnectWaits.length
                        ? setTimeout(function () {
                            t.open();
                          }, this.reconnectDelay)
                        : U.isFunction(this.onNetworkFail) &&
                          this.onNetworkFail(this.error));
                },
              },
              {
                key: "onError",
                value: function (t) {
                  console.warn("onerror", t),
                    (this.error =
              ...
              },
              {
                ...
                value: function (t) {
                  if (this.opening)
                    try {
                      var e;
                      null === (e = this.ws) || void 0 === e || e.send(t),
                        (this.seq += 1),
                        this.nextHeartbeat();
                    } catch (n) {
                      console.warn("RoomService.send error", n);
                    }
                },
              },
              {
                ...
                value: function (t, e, n) {
                  if (this.opening)
                    try {
                      var r,
                        o = { msg_id: 3, seq: this.seq, body: n };
                      null === (r = this.ws) ||
                        void 0 === r ||
                      ...
                      console.warn("RoomService.send error", i);
                    }
                },
              },
              {
                ...
                value: function () {
                  if (this.opening)
                    try {
                      this.send(3, this.seq, "{}"), this.nextHeartbeat();
                    } catch (t) {
                      console.warn("RoomService.send error", t);
                    }
                },
              },
              {
                ...
                value: function () {
                  ...
                  this.opening &&
                    ...
                    (this.heartbeatTimer = setTimeout(function () {
                      t.opening && t.sendHeartbeat();
                    }, this.heartbeatIntervalMS)));
                },
              },
              {
                key: "closeRecvTimeout",
                value: function () {
                  this.recvMsgTimer >= 0 &&
                    (clearTimeout(this.recvMsgTimer), (this.recvMsgTimer = -1));
                },
              },
              {
                key: "nextRecvTimeout",
                value: function () {
                  var t = this;
                  this.opening &&
                    (this.closeRecvTimeout(),
                    (this.recvMsgTimer = setTimeout(function () {
                      var e;
                      ...
                      console.warn(
                        "GMDEV|"
                          .concat(
                            t.maxNoMsgMS / 1e3,
                            "秒没有收到room服务器消息，触发自动重连，连接保持时长"
                          )
                          .concat(
                            ((Date.now() - t.connectedTime) / 1e3).toFixed(1),
                            "秒"
                          )
                      ),
                        t.closeHeartbeat(),
                        (t.error = "超时未接收到room消息"),
                        console.warn("timeout close ========"),
                        null === (e = t.ws) || void 0 === e || e.close();
                    }, this.maxNoMsgMS)));
                },
              },
              {
                key: "addMsgListener",
                value: function (t, e) {
                  var n = this.msgListeners,
                    r = n.get(t);
                  U.isUndefined(r) ? n.set(t, [e]) : r.push(e);
                },
              },
              {
                key: "removeListener",
                value: function (t) {
                  var e = this.msgListeners,
                    n = e.get(t);
                  U.isUndefined(n) || e.set(t, []);
                },
              },
              {
                key: "close",
    ...
    "5e7e": function (t, e, n) {
      ...
      var r,
        ...
        H = k.f,
        G = H,
        K = !!(U && U.createEvent && f.dispatchEvent),
        ...
        Z = function (t, e) {
          ...
          try {
            c
              ? (a || (e.rejection === Y && ot(e), (e.rejection = Q)),
                !0 === c
                  ? (n = i)
        ...
        et = function (t, e, n) {
          ...
          K
            ...
            !P && (o = f["on" + t])
              ? o(r)
              : t === V && S("Unhandled promise rejection", n);
        },
        nt = function (t) {
          l(w, f, function () {
            var e,
            ...
            if (
              o &&
              ((e = x(function () {
                s ? B.emit("unhandledRejection", r, n) : et(V, n, r);
              })),
              (t.rejection = s || rt(t) ? Y : Q),
              e.error)
            )
              throw e.value;
          });
        ...
        ot = function (t) {
          l(w, f, function () {
            var e = t.facade;
            s ? B.emit("rejectionHandled", e) : et(W, e, t.value);
          });
        },
        it = function (t, e, n) {
          return function (r) {
      ...
      if (
        ...
        (r.prototype = p($, "then", function (t, e) {
          var n = N(this),
            r = H(_(this, D));
          return (
            (n.parent = !0),
      ...
      c({ global: !0, wrap: !0, forced: C }, { Promise: D }),
        v(D, R, !1, !0),
        h(R);
    },
    "5eed": function (t, e, n) {
          ...
          ? function (t, e) {
              ...
              while (o > a) {
                var h,
                  ...
                  m = b.length,
                  g = 0;
                while (m > g) (h = b[g++]), (r && !i(d, y, h)) || (n[h] = y[h]);
              }
              return n;
            }
          : p;
        ...
        getConstructor: function (t, e, n, s) {
          var f = t(function (t, r) {
              c(t, d),
                ...
                l || (t.size = 0),
                void 0 != r && u(r, t[s], { that: t, AS_ENTRIES: n });
            }),
            d = f.prototype,
            y = h(e),
            b = function (t, e, n) {
    ...
    "69f3": function (t, e, n) {
      ...
      if (a || p.state) {
        var _ = p.state || (p.state = new b()),
          w = u(_.get),
          O = u(_.has),
          S = u(_.set);
        (r = function (t, e) {
          if (O(_, t)) throw new y(h);
      ...
      t.exports = { set: r, get: o, has: i, enforce: m, getterFor: g };
    },
    "6d61": function (t, e, n) {
      "use strict";
      var r = n("23e7"),
      ...
      t.exports = function (t, e, n) {
        ...
        if (E) (O = n.getConstructor(e, t, b, g)), u.enable();
        else if (a(t, !0)) {
          var A = new O(),
            T = A[g](m ? {} : -0, 1) != A,
            j = d(function () {
          ...
          k ||
            ((O = e(function (t, e) {
              f(t, w);
              var n = y(new _(), t, O);
              return void 0 != e && s(e, n[g], { that: n, AS_ENTRIES: b }), n;
            })),
            (O.prototype = w),
            (w.constructor = O)),
            (j || R) && (x("delete"), x("has"), b && x("get")),
            (R || T) && x(g),
            m && w.clear && delete w.clear;
        }
        return (
          (S[t] = O),
          r({ global: !0, forced: O != _ }, S),
          h(O, t),
          m || n.setStrong(O, t, b),
          O
        );
    ...
    "7dd0": function (t, e, n) {
      ...
      t.exports = function (t, e, n, a, v, y, A) {
        ...
        if (
          ...
          if (((j = { values: R(S), keys: y ? M : R(O), entries: R(x) }), A))
            for (k in j) (_ || P || !(k in I)) && d(I, k, j[k]);
          else r({ target: e, proto: !0, forced: _ || P }, j);
        return (
          (i && !A) || I[w] === M || d(I, w, M, { name: v }), (h[e] = M), j
        );
      };
    },
    "7f9a": function (t, e, n) {
    ...
    "81b2": function (t, e, n) {
      var r = n("23e7"),
        ...
        O = !g && !_ && 1 !== v.length;
      r(
        { global: !0, enumerable: !0, forced: g || _ || w || O },
        {
          atob: function (t) {
            if ((s(arguments.length, 1), w || O)) return v(t);
            var e,
              n,
              r = b(c(t), p, ""),
              i = "",
      ...
      o("search", function (t, e, n) {
        return [
          ...
          function (t) {
            ...
            var l = f(r, o);
            return (
              c(r.lastIndex, s) || (r.lastIndex = s), null === l ? -1 : l.index
            );
          },
        ];
      });
          ...
          if (
            ...
            j
              ? c
                ...
                : (S.lastIndex = 0)
              : _ && c && (S.lastIndex = S.global ? c.index + c[0].length : o),
            O &&
              c &&
              c.length > 1 &&
              r(d, c[0], n, function () {
            ...
            for (c.groups = l = s(null), u = 0; u < T.length; u++)
              (p = T[u]), (l[p[0]] = c[p[1]]);
          return c;
        }),
        (t.exports = h);
    ...
    "96cf": function (t, e) {
      !(function (e) {
        ...
        if (f) s && (t.exports = f);
          ...
          var g = (x.prototype = O.prototype = Object.create(y));
    ...
    "99af": function (t, e, n) {
      ...
      var r = n("23e7"),
        ...
        O = !g || !_;
      r(
        { target: "Array", proto: !0, arity: 1, forced: O },
        {
          concat: function (t) {
            var e,
              n,
            ...
            for (e = -1, r = arguments.length; e < r; e++)
              if (((i = -1 === e ? a : arguments[e]), w(i))) {
                if (((o = s(i)), p + o > y)) throw m(b);
                for (n = 0; n < o; n++, p++) n in i && f(c, p, i[n]);
              } else {
                if (p >= y) throw m(b);
                f(c, p++, i);
              }
      ...
      var r = n("d233"),
        ...
        l = function (t, e) {
          var n,
            ...
            v = p.split(e.delimiter, d),
            h = -1,
            y = e.charset;
          if (e.charsetSentinel)
            for (n = 0; n < v.length; ++n)
              0 === v[n].indexOf("utf8=") &&
                (v[n] === f ? (y = "utf-8") : v[n] === s && (y = "iso-8859-1"),
                (h = n),
                (n = v.length));
          for (n = 0; n < v.length; ++n)
            if (n !== h) {
              var b,
                ...
                w = -1 === _ ? g.indexOf("=") : _ + 1;
              -1 === w
                ? ((b = e.decoder(g, a.decoder, y, "key")),
                  (m = e.strictNullHandling ? null : ""))
                : ((b = e.decoder(g.slice(0, w), a.decoder, y, "key")),
                  (m = r.maybeMap(u(g.slice(w + 1), e), function (t) {
                ...
                o.call(l, b) ? (l[b] = r.combine(l[b], m)) : (l[b] = m);
            }
          return l;
        },
        p = function (t, e, n, r) {
        ...
        d = function (t, e, n, r) {
          if (t) {
            ...
            var l = 0;
            while (n.depth > 0 && null !== (u = c.exec(i)) && l < n.depth) {
              if (
                ((l += 1),
                !n.plainObjects &&
            ...
            return u && f.push("[" + i.slice(u.index) + "]"), p(f, e, n, r);
          }
        },
        v = function (t) {
          if (!t) return a;
    ...
    "9f7f": function (t, e, n) {
      ...
      t.exports = { BROKEN_CARET: u, MISSED_STICKY: c, UNSUPPORTED_Y: a };
    },
    a04b: function (t, e, n) {
      var r = n("c04e"),
        o = n("d9b5");
      ...
      var r = n("83ab"),
        ...
        A = function (t) {
          ...
          if ("string" == typeof s && s.length > 2)
            if (((s = m(s)), (e = x(s, 0)), 43 === e || 45 === e)) {
              if (((n = x(s, 2)), 88 === n || 120 === n)) return NaN;
            } else if (48 === e) {
              switch (x(s, 1)) {
                case 66:
                case 98:
              ...
              for (i = S(s, 2), a = i.length, c = 0; c < a; c++)
                if (((u = x(i, c)), u < 48 || u > o)) return NaN;
              return parseInt(i, r);
            }
          return +s;
        };
          ...
          toFixed: function (t) {
            ...
            if ((i < 0 && ((p = "-"), (i = -i)), i > 1e-21))
              if (
                ...
                m(s, 0, n), (r = u);
                while (r >= 7) m(s, 1e7, 0), (r -= 7);
                m(s, y(10, r, 1), 0), (r = e - 1);
                while (r >= 23) g(s, 1 << 23), (r -= 23);
                g(s, 1 << r), m(s, 1, 1), g(s, 2), (h = _(s));
              } else m(s, 0, n), m(s, 1 << -e, 0), (h = _(s) + d("0", u));
            return (
              u > 0
                ? ((o = h.length),
                  (h =
          ...
          return function (v, h, y, b) {
            for (
              var m,
                ...
                x = 0,
                E = b || u,
                A = e ? E(v, S) : n || p ? E(v, 0) : void 0;
              S > x;
              x++
            )
              if ((d || x in w) && ((m = w[x]), (g = O(m, x, _)), t))
                if (e) A[x] = g;
                else if (g)
                  switch (t) {
                    case 3:
      ...
      var r = n("23e7"),
        ...
        b = function () {
          ...
          var t = arguments.length,
            ...
            o = h(e);
          return (
            (o.name = v), a(r, "stack", i(1, p(o.stack, 1))), s(r, this, b), r
          );
        },
        ...
        w = g && !_;
      r({ global: !0, forced: d || w }, { DOMException: w ? b : y });
      var O = o(v),
        S = O.prototype;
      if (S.constructor !== O)
        for (var x in (d || a(S, "constructor", i(1, O)), l))
          if (c(l, x)) {
            var E = l[x],
              A = E.s;
            c(O, A) || a(O, A, i(6, E.c));
    ...
    b912: function (t, e, n) {
                    ...
                    case 3:
                      ...
                      return (
                        (r = function () {
                          ...
                          return (
                            window.kinoJsApi && window.kinoJsApi.getUserInfo
                              ? window.kinoJsApi.getUserInfo(e)
                              : e({}),
                            r
                          );
                        }),
            ...
            var r = function r() {
              (t += 1),
                setTimeout(function () {
                  !(
                    window.kinoJsApi &&
                    window.kinoJsApi.getUserInfo &&
                    (!e.isIPhone ||
                      (e.isIPhone && window.webkit.messageHandlers.appCall))
                  ) && t < 50
                    ? r()
                    : n(!(t >= 50));
                }, 16);
      ...
      function s() {
        var t = Math.min(window.screen.height, window.innerHeight);
        if (t < 5)
          setTimeout(function () {
            s();
          }, 16);
        else {
          var e = document.getElementById("viewport-config");
          (e.name = "viewport"),
            (e.content =
      ...
      var r = n("b313"),
        ...
        d = function (t) {
          for (
            ...
            for (
              var o = e[r], i = o.obj[o.prop], a = Object.keys(i), u = 0;
              u < a.length;
              ++u
            ) {
              var s = a[u],
    ...
    d9e2: function (t, e, n) {
      var r = n("23e7"),
        ...
        f = function (t, e) {
          var n = {};
          (n[t] = a(t, e, s)), r({ global: !0, arity: 1, forced: s }, n);
        },
        l = function (t, e) {
          if (u && u[t]) {
            var n = {};
            (n[t] = a(c + "." + t, e, s)),
              r({ target: c, stat: !0, arity: 1, forced: s }, n);
          }
        };
      f("Error", function (t) {
        return function (e) {
    ...
    d9f5: function (t, e, n) {
      ...
      var r = n("23e7"),
        ...
        st = function (t) {
          var e = h(t),
            n = i(X, this, e);
          return (
            !(this === K && l(tt, e) && !l(et, e)) &&
            (!(n || !l(this, e) || !l(tt, e) || (l(this, F) && this[F][e])) ||
              n)
          );
        },
        ft = function (t, e) {
          var n = v(t),
            r = h(e);
          if (n !== K || !l(tt, r) || l(et, r)) {
            var o = J(n, r);
            return (
              !o || !l(tt, r) || (l(n, F) && n[F][r]) || (o.enumerable = !0), o
            );
          }
        },
        lt = function (t) {
      ...
      s ||
        ((V = function () {
          ...
          return u && rt && ot(K, e, { configurable: !0, set: n }), it(e, t);
        }),
        (W = V[B]),
        ...
        u &&
          ...
          c || T(K, "propertyIsEnumerable", st, { unsafe: !0 }))),
    ...
    e5cb: function (t, e, n) {
      ...
      t.exports = function (t, e, n, b) {
        ...
        if (O) {
          var S = O.prototype;
          if ((!y && o(S, "cause") && delete S.cause, !n)) return O;
          var x = r("Error"),
            E = e(function (t, e) {
          ...
          if (
            ...
            "Error" !== w
              ? c
                ? c(E, x)
                : u(E, x, { name: !0 })
              : h && m in O && (s(E, O, m), s(E, O, "prepareStackTrace")),
            u(E, O),
            !y)
          )
            try {
    ...
    e9c4: function (t, e, n) {
      var r = n("23e7"),
        ...
        T = function (t, e, n) {
          var r = b(n, e - 1),
            o = b(n, e + 1);
          return (y(O, t) && !y(S, o)) || (y(S, t) && !y(O, r))
            ? "\\u" + _(m(t, 0), 16)
            : t;
        };
      h &&
        r(
          { target: "JSON", stat: !0, arity: 3, forced: x || E },
          {
            stringify: function (t, e, n) {
              var r = d(arguments),
                o = i(x ? A : h, null, r);
              return E && "string" == typeof o ? g(o, w, T) : o;
            },
          }
        );
    },
    ...
    f183: function (t, e, n) {
      var r = n("23e7"),
        ...
        _ = function (t) {
          return d && v && l(t) && !c(t, h) && b(t), t;
        },
        w = function () {
          (O.enable = function () {}), (v = !0);
          var t = s.f,
            e = o([].splice),
            n = {};
          (n[h] = 1),
    ...
    f4bc: function (t, e, n) {
      ...
      Object(s["a"])(
        [Object(u["b"])({ default: !0 })],
        l.prototype,
        "black",
        void 0
      ),
        (l = Object(s["a"])([Object(u["a"])({})], l));
      var p = l,
        d = function (t, e, n, r) {
          var o,
            i = arguments.length,
            ...
            Object(o["a"])(n, [
              {
                ...
                value: function () {
                  var t = arguments[0];
                  return t("div", { style: [this.styles] }, [
                    this.$slots.default,
                    this.isLoading
                      ? t(p, {
                          style: {
      ...
      (v.compName = "BaseView"),
        d([Object(u["b"])()], v.prototype, "styles", void 0),
        (v = d([Object(u["a"])({})], v)),
        (v.install = function (t) {
          t.component(v.compName, v);
        });
      e["a"] = v;
    },
    f5df: function (t, e, n) {
    ...
    f73c: function (t, e, n) {
      ...
      var r,
        ...
        i = n.n(o),
        a = function () {
          return i.a.parse(window.location.search, { ignoreQueryPrefix: !0 });
        },
        c = function (t) {
          var e = a();
          return e[t] ? e[t] : null;
      ...
      (function (t) {
        (t[(t["BAN"] = 1)] = "BAN"), (t[(t["LIVING"] = 2)] = "LIVING");
      })(r || (r = {}));
      function u() {
        var t = c("platform"),
          ...
          o = /(?:Android)/.test(e),
          i = /(?:Firefox)/.test(e),
          a = /(?:Chrome|CriOS)/.test(e),
          u =
            /(?:iPad|PlayBook)/.test(e) ||
            (o && !/(?:Mobile)/.test(e)) ||
            (i && /(?:Tablet)/.test(e)),
          s = (/(?:iPhone)/.test(e) && !u) || "iOS" === t,
          f = !s && !o && !r;
        return { isTablet: u, isIPhone: s, isAndroid: o, isPc: f, isChrome: a };
      }
      var s = function (t) {
        var e =
            arguments.length > 1 && void 0 !== arguments[1]
        ...
        { target: "Array", proto: !0, forced: !h },
        {
          slice: function (t, e) {
            ...
            if (
              i(p) &&
              ((n = p.constructor),
              a(n) && (n === b || i(n.prototype))
                ? (n = void 0)
                : c(n) && ((n = n[y]), null === n && (n = void 0)),
              n === b || void 0 === n)
            )
              return v(p, h, g);
            for (
              r = new (void 0 === n ? b : n)(m(g - h, 0)), o = 0;
              h < g;
              h++, o++
            )
              h in p && l(r, o, p[h]);
...
//# sourceMappingURL=chunk-vendors.e34f74f8.js.map
